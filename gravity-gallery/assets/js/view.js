		...
		render: function(data){
			...
			if (Y.Lang.isValue(data.photos.photo)) {
				Y.each(data.photos.photo, function(r){
					img = Y.Node.create('<li><a target="_blank" id="photo-'+r.id+'" href="http://www.flickr.com/photos/'+r.owner+'/'+r.id+'/"><img class="thumb" src="" data-flickr-id="' + r.id + '" alt="' + r.title + '"/></a></li>');
					c.appendChild(img);
